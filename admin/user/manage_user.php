...
<div class="card card-outline rounded-0 card-teal">
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">
				...
				<div class="form-group">
					...
					<input type="text" name="middlename" id="middlename" class="form-control" value="<?php echo isset($meta['middlename']) ? $meta['middlename'] : '' ?>" readonly>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<?php if (isset($meta['id'])) : ?>
						<small><i>Deja este campo vacío si no deseas cambiar la contraseña</i></small>
					<?php endif; ?>
				</div>
				<div class="form-group">
					...
					<select name="type" id="type" class="form-control form-control-sm rounded-0" required>
						...
						<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Emplead@</option>
					</select>
				</div>
				<div class="form-group">
	...
	<div class="card-footer">
		<div class="col-md-12">
			<div class="row">
				<button class="btn btn-sm btn-primary rounded-0 mr-3" form="manage-user">Guardar Información del Usuario</button>
