...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("¿Deseas eliminar este cliente de forma permanente?", "delete_client", [$(this).attr('data-id')])
		})
		$('#create_new').click(function() {
			uni_modal("<i class='far fa-plus-square'></i> Agregar Cliente ", "clients/manage_client.php")
		})
		$('.edit-data').click(function() {
			uni_modal("<i class='fa fa-edit'></i> Agregar Cliente ", "clients/manage_client.php?id=" + $(this).attr('data-id'))
		})
		$('.view-data').click(function() {
			uni_modal("<i class='fa fa-th-list'></i> Información de Cliente ", "clients/view_client.php?id=" + $(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [{
				orderable: false,
